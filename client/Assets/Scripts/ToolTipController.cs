...
public class ToolTipController : MonoBehaviour {
    ...
    IEnumerator ShowToolTip(GameObject CurrentButtom)
    {
        ...
        if (ToolTipReference != null)
        {
            ToolTipReference.transform.FindChild("ToolTipBackground").GetComponent<RectTransform>().sizeDelta = new Vector2(ToolTipReference.transform.FindChild("ToolTipText").GetComponent<RectTransform>().rect.width - 14, 12);
            //offset
