...
public class ToolTipController : MonoBehaviour {
    ...
    public void SpawnToolTip(GameObject CurrentButtom)
    {
        if (ToolTipReference == null)
        {
            ...
            ToolTipReference.transform.localScale = new Vector3(1, 1, 1);
    ...
    IEnumerator ShowToolTip(GameObject CurrentButtom)
    {
        ...
        if (ToolTipReference != null)
        {
            //ToolTipReference.transform.FindChild("ToolTipBackground").GetComponent<RectTransform>().sizeDelta = new Vector2(ToolTipReference.transform.FindChild("ToolTipText").GetComponent<RectTransform>().rect.width - 55, 20);
            //offset
