...
public class CreateConnectionInfopanel : MonoBehaviour, IPointerClickHandler
{
    ...
    public int atom_id_0;
    public int atom_id_1;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        asc.atom_selected_p2 = atom_id_1;
        asc.atom_selected_p1 = atom_id_0;

        asc.AddConnectionButton_from_amino_info_panel(A1Button, A2Button, amino_id_0, amino_id_1);
    }

    public void SetValues(int amino1, int amino2, int atom1, int atom2, int protein, GameObject a1, GameObject a2)
    {
        amino_id_0 = amino1;
        amino_id_1 = amino2;
        atom_id_0 = atom1;
